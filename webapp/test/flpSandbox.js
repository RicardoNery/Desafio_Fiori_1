		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Alteraração Preço Caixa",
									"targetURL": "#precocaixasolpreco01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"precocaixasolpreco01-display": {
								"semanticObject": "precocaixasolpreco01",
								"action": "display",
								"description": "Alterar preço caixa",
								"title": "Alteraração Preço Caixa",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=preco.caixa.sol.preco01",
									"url": sap.ui.require.toUrl("preco/caixa/sol/preco01")
								}
							}
						}
					}
